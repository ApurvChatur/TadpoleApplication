...
const ProfileRetrieveComponent = ({ Redux }) => {
  ...
  return (
    <React.Fragment>
      <section class="bg-[#F0EDCC] dark:bg-[#02343F] text-[#02343F] dark:text-[#F0EDCC] lg:px-20">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                  ...
                  <div class="w-12 h-1 bg-[#02343F] dark:bg-[#F0EDCC] rounded mt-2 mb-4"></div>
        ...
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#02343F] dark:border-[#F0EDCC] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#02343F] dark:border-[#F0EDCC] leading-none">Critical Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#02343F] dark:border-[#F0EDCC] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#02343F] dark:border-[#F0EDCC] leading-none">Basic Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#02343F] dark:border-[#F0EDCC] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#02343F] dark:border-[#F0EDCC] leading-none">Relation Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-[#02343F] dark:border-[#F0EDCC] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#02343F] dark:border-[#F0EDCC] leading-none">More Information</h1>
